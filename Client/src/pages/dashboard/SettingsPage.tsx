...
import ChangeRequestChatbot from '../../components/change-request/ChangeRequestChatbot';
...
const SettingsPage: React.FC = () => {
  ...
  // Chatbot logic moved to global SupportChatbot component
    ...
    <section id="settings" className="page active" style={{ display: 'block', paddingBottom: '100px' }}>
      ...
      <div style={{ display: 'grid', gap: '20px', maxWidth: '700px', margin: '0 auto' }}>
        ...
        <div className="glass-card" style={{ padding: '28px' }}>
          ...
          <div className="cr-settings-trigger" onClick={() => setIsChatbotOpen(true)}>
            <div className="cr-settings-trigger-icon">
            ...
            <div>
              <div className="cr-settings-trigger-text">Request Information Change</div>
              <div className="cr-settings-trigger-hint">Need to update your personal details? Credify Assistant will guide you.</div>
            </div>
            <div className="cr-settings-trigger-arrow">
        ...
        {(isDirty || isSavedAnimating) && (
          ...
          {/* Chatbot removed from SettingsPage */}


      </div>

      {/* Change Request Chatbot */}
      <ChangeRequestChatbot
