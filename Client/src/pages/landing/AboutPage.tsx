      ...
      <div className="py-16 md:py-24 bg-white border-b border-slate-100">
        <div className="max-w-5xl mx-auto px-6 sm:px-12">
          <div className="bg-[#E0F2FE] rounded-3xl p-6 sm:p-10 md:p-14 border border-[#DCFCE7] shadow-sm">
            ...
            <div className="mt-8 md:mt-12 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-5 sm:p-8 md:p-10 border border-blue-200/60 shadow-sm">
              <div className="flex flex-col lg:flex-row gap-8 items-center">
                <div className="lg:w-2/5 w-full shrink-0">
                  <div className="rounded-2xl overflow-hidden shadow-lg border-2 border-white/80 hover:scale-[1.02] transition-transform duration-300 max-w-sm mx-auto lg:max-w-none">
                    <img
                ...
                <div className="lg:w-3/5 w-full">
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold px-6 py-3 rounded-xl transition-all duration-200 shadow-md hover:shadow-lg hover:-translate-y-0.5 w-full sm:w-auto"
                  >
