...
const AdminFraudPage: React.FC = () => {
  ...
  return (
    <>
      ...
      {selectedAlert && <div id="drawer-overlay" className="drawer-overlay open" onClick={() => setSelectedAlertId(null)}></div>}

      {/* Fraud Alert Drawer */}
      <div id="drawer" className={`drawer-panel ${selectedAlert ? "open" : ""}`}>
