...
import { ShieldHalf, Lock, BadgeCheck, Users, Zap, CheckCircle2, ArrowLeft } from 'lucide-react';
...
const AuthLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-auth-bg auth-bg flex items-center justify-center overflow-x-hidden overflow-y-auto font-b p-4 md:p-8 relative">
      <button
        onClick={() => navigate('/')}
        className="absolute top-4 left-4 md:top-8 md:left-8 z-[200] flex items-center gap-2 text-auth-text-mid hover:text-auth-text-dark transition-colors bg-white/50 backdrop-blur-md px-4 py-2 rounded-full shadow-sm border border-white/20"
      >
      ...
      <div className={cn(
        "bg-auth-card backdrop-blur-[16px] rounded-[32px] shadow-[0_0_0_1px_rgba(255,255,255,0.6),0_36px_90px_rgba(14,31,66,0.14),0_8px_28px_rgba(14,31,66,0.07)] relative w-[min(1020px,95vw)] min-h-[700px] my-auto overflow-hidden",
